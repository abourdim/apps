...
const INLINE_APPS = [
  ...
  { name:"amthal", emoji:"📖", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Amthal — explore and experiment!", fr:"Amthal — explorez et expérimentez !", ar:"Amthal — استكشف وجرّب!" }},
  { name:"apps", emoji:"🏠", categories:["tools", "camera", "classroom", "arabic", "microbit", "learning"], badge:"new", status:"dev", tags:["BLE","WebRTC","camera","TTS","STT","micro:bit","security","HTML"],
  ...
  { name:"avahi", emoji:"🔎", categories:["tools"], badge:"new", status:"dev", tags:[],
  ...
  { name:"cowsay", emoji:"🐄", categories:["tools"], badge:"new", status:"dev", tags:[],
  ...
  { name:"mdns", emoji:"🌐", categories:["tools"], badge:"new", status:"dev", tags:[],
  ...
  { name:"ngrok", emoji:"🚇", categories:["tools"], badge:"new", status:"dev", tags:[],
  ...
  { name:"ocpp", emoji:"⛽", categories:["tools", "learning", "microbit"], badge:"new", status:"dev", tags:["BLE","git","HTML"],
  ...
  { name:"template", emoji:"📄", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Template — explore and experiment!", fr:"Template — explorez et expérimentez !", ar:"Template — استكشف وجرّب!" }},
  { name:"tesbih", emoji:"📿", categories:["tools"], badge:"new", status:"dev", tags:[],
  ...
  { name:"tshark", emoji:"🐋", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Tshark — explore and experiment!", fr:"Tshark — explorez et expérimentez !", ar:"Tshark — استكشف وجرّب!" }},
  { name:"tty", emoji:"🖥️", categories:["microbit"], badge:"new", status:"dev", tags:["BLE","WebSerial","git","linux","HTML","LED"],
