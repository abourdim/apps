...
const INLINE_APPS = [
  /* ── micro:bit (8) ── */
  { name:"bit-bot", emoji:"🤖", category:"microbit", badge:"popular", status:"stable",
    tags:["robot","micro:bit","BLE","speech"],
  ...
  { name:"talking-robot", emoji:"🤖", category:"microbit", badge:"", status:"stable",
    tags:["robot","micro:bit","BLE","speech","TTS"],
  ...
  { name:"bitmoji-lab", emoji:"😄", category:"microbit", badge:"", status:"stable",
    tags:["emoji","micro:bit","BLE","LED","serial"],
  ...
  { name:"bit-playground", emoji:"🧩", category:"microbit", badge:"", status:"stable",
    tags:["micro:bit","BLE","LED","sensors","serial","gamepad"],
  ...
  { name:"rxy", emoji:"🎛️", category:"microbit", badge:"", status:"stable",
    tags:["micro:bit","BLE","remote","serial","builder"],
  ...
  { name:"pixel-gateway", emoji:"🕹️", category:"microbit", badge:"", status:"beta",
    tags:["pixel","micro:bit","BLE","serial","retro","art"],
    desc:{ en:"A retro pixel art portal — draw, animate & send pixel art to micro:bit.", fr:"Un portail pixel art rétro — dessinez, animez et envoyez du pixel art au micro:bit.", ar:"بوابة بيكسل آرت ريترو — ارسم وحرّك وأرسل فن البكسل إلى micro:bit." }},
  { name:"usb-logger", emoji:"🔌", category:"microbit", badge:"", status:"stable",
    tags:["micro:bit","USB","serial","logger"],
  ...
  { name:"ble-logger", emoji:"📡", category:"microbit", badge:"", status:"stable",
    tags:["micro:bit","BLE","bluetooth","logger"],
  ...
  /* ── Camera (4) ── */
  { name:"magic-hands", emoji:"🪄", category:"camera", badge:"popular", status:"stable",
    tags:["camera","hand-tracking","mediapipe","AI/ML"],
  ...
  { name:"face-quest", emoji:"🕵️", category:"camera", badge:"", status:"stable",
    tags:["camera","face","micro:bit","BLE","game"],
  ...
  { name:"teachable-machine", emoji:"🧠", category:"camera", badge:"popular", status:"stable",
    tags:["camera","AI/ML","micro:bit","BLE","speech","tensorflow"],
    desc:{ en:"Teach gestures/sounds via camera, then control a micro:bit over Bluetooth.", fr:"Enseignez des gestes/sons via la caméra, puis contrôlez un micro:bit en Bluetooth.", ar:"علّم إيماءات/أصوات عبر الكاميرا، ثم تحكم في micro:bit عبر البلوتوث." }},
  { name:"face-tracking", emoji:"😎", category:"camera", badge:"", status:"stable",
    tags:["camera","face-tracking","micro:bit","BLE","mediapipe"],
  ...
  /* ── Arabic (3) ── */
  { name:"arabic-translator", emoji:"📖", category:"arabic", badge:"", status:"
  [1mPick status:[0m

    [0;32m1[0m)  [0;32mstable[0m    ── fully working, tested, ready for users
    [1;33m2[0m)  [1;33mbeta[0m      ── works but may have rough edges or missing features
    [0;35m3[0m)  [0;35mdev[0m       ── under active development, may not work yet
    [0;31m4[0m)  [0;31moffline[0m   ── temporarily down, broken, or deprecated
    [0;36m5[0m)  [0;36mcustom[0m    ── enter your own status label

offline",
    tags:["arabic","translate","speech","browser-only"],
  ...
  { name:"arabic-speaker", emoji:"🗣️", category:"arabic", badge:"", status:"dev",
    tags:["arabic","TTS","STT","speech"],
  ...
  { name:"piper-arabic-tts", emoji:"🎙️", category:"arabic", badge:"", status:"dev",
    tags:["arabic","TTS","piper","WASM"],
  ...
  /* ── Classroom (2) ── */
  { name:"mission-control", emoji:"🚀", category:"classroom", badge:"", status:"stable",
    tags:["camera","micro:bit","BLE","webRTC","video","chat"],
  ...
  { name:"classroom", emoji:"🏫", category:"classroom", badge:"", status:"beta",
    tags:["camera","webRTC","peerjs","video","classroom"],
  ...
  /* ── Hardware (3) ── */
  { name:"wled-kids-lab", emoji:"💡", category:"hardware", badge:"", status:"beta",
    tags:["WLED","LED","ESP32","serial","IoT","flash"],
  ...
  { name:"esp32-c3-kids-lab", emoji:"⚡", category:"hardware", badge:"", status:"beta",
    tags:["ESP32","ESPHome","serial","IoT","hardware"],
  ...
  { name:"circuit-lab", emoji:"🔧", category:"hardware", badge:"new", status:"beta",
    tags:["circuit","camera","electronics","simulator"],
    desc:{ en:"Circuit Lab — build and simulate electronic circuits in the browser.", fr:"Circuit Lab — construisez et simulez des circuits électroniques dans le navigateur.", ar:"Circuit Lab — ابنِ وحاكِ الدوائر الإلكترونية في المتصفح." }},

  /* ── Learning (7) ── */
  { name:"crypto-academy", emoji:"💰", category:"learning", badge:"", status:"beta",
    tags:["crypto","blockchain","camera","education"],
  ...
  { name:"pentest-lab", emoji:"🔐", category:"learning", badge:"", status:"beta",
    tags:["security","pentest","cybersecurity"],
  ...
  { name:"linux-kids-lab", emoji:"🐧", category:"learning", badge:"", status:"beta",
    tags:["linux","terminal","commands","serial"],
  ...
  { name:"production-chain", emoji:"🏭", category:"learning", badge:"", status:"beta",
    tags:["simulation","industry","factory"],
  ...
  { name:"3d-lab", emoji:"🎨", category:"learning", badge:"new", status:"beta",
    tags:["3D","camera","maker","creative"],
    desc:{ en:"3D Maker Lab — design, explore and create in 3D.", fr:"3D Maker Lab — concevez, explorez et créez en 3D.", ar:"معمل ثلاثي الأبعاد — صمم واستكشف وابتكر." }},
  { name:"git-lab", emoji:"🌿", category:"learning", badge:"new", status:"beta",
    tags:["git","github","version-control"],
    desc:{ en:"GitHub Kids Lab — learn Git and version control the fun way.", fr:"GitHub Kids Lab — apprends Git et le contrôle de version en t'amusant.", ar:"معمل GitHub للأطفال — تعلم Git والتحكم في الإصدارات بطريقة ممتعة." }},
  { name:"save-our-planet", emoji:"🌍", category:"learning", badge:"new", status:"beta",
    tags:["environment","planet","awareness","education"],
    desc:{ en:"Save Our Planet — learn about the environment and how to protect it.", fr:"Sauvons notre planète — apprends à protéger l'environnement.", ar:"أنقذ كوكبنا — تعلم عن البيئة وكيفية حمايتها." }},

  /* ── AI (2) ── */
  { name:"claude-toolkit", emoji:"🧰", category:"ai", badge:"new", status:"beta",
    tags:["AI","claude","CLI","tools"],
  ...
  { name:"prompt-hero", emoji:"✨", category:"ai", badge:"new", status:"beta",
    tags:["AI","prompt","micro:bit","serial"],
    desc:{ en:"Prompt Hero — craft, test and share AI prompts.", fr:"Prompt Hero — crée, teste et partage des prompts IA.", ar:"Prompt Hero — صمم واختبر وشارك موجّهات الذكاء الاصطناعي." }},

  /* ── Tools (5) ── */
  { name:"puppeteer-playground", emoji:"🎭", category:"tools", badge:"", status:"beta",
    tags:["puppeteer","automation","scraping","testing"],
  ...
  { name:"workshop-diy", emoji:"🏗️", category:"tools", badge:"", status:"beta",
    tags:["website","hub","STEM","robotics"],
  ...
  { name:"all", emoji:"🏠", category:"tools", badge:"hub", status:"stable",
    tags:["hub","portal","apps"],
  ...
  { name:"rocket-shield-vpn", emoji:"🛡️", category:"tools", badge:"new", status:"beta",
    tags:["VPN","webRTC","privacy","network"],
    desc:{ en:"Rocket Shield VPN — privacy and network tools.", fr:"Rocket Shield VPN — outils de confidentialité et réseau.", ar:"Rocket Shield VPN — أدوات الخصوصية والشبكات." }},
  { name:"ops-catalog", emoji:"📋", category:"tools", badge:"new", status:"beta",
    tags:["ops","camera","micro:bit","webRTC","catalog"],
    desc:{ en:"Ops Catalog — manage and monitor your Workshop-Diy apps.", fr:"Ops Catalog — gère et surveille tes apps Workshop-Diy.", ar:"كتالوج العمليات — أدِر وراقب تطبيقات Workshop-Diy." }},
];
