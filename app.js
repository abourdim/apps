...
/* ============================================================
   ...
   ============================================================ */
const INLINE_APPS = [
  { name:"3d-lab", emoji:"🧊", categories:["learning"], badge:"dev", status:"beta", visibility:"private", tags:["3D", "three.js", "modeling", "creative"],
  ...
  { name:"AI-hacker-lab", emoji:"🤯", categories:["ai", "learning", "microbit", "hardware", "tools", "camera", "classroom"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "tensorflow", "micro:bit", "ESP32", "game", "git", "HTML"],
  ...
  { name:"arabic-tts", emoji:"🔊", categories:["arabic", "tools", "microbit", "ai"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "game", "git", "linux", "HTML", "LED"],
  ...
  { name:"bit-54-activities", emoji:"🎯", categories:["microbit", "learning"], badge:"dev", status:"beta", visibility:"private", tags:["micro:bit", "activities", "projects", "beginner", "advanced"],
  ...
  { name:"bit-bot", emoji:"🤖", categories:["microbit"], badge:"popular", status:"stable", visibility:"private", tags:["robot", "micro:bit", "BLE", "AI", "chatbot"],
  ...
  { name:"bit-playground", emoji:"🕹️", categories:["microbit"], badge:"stable", status:"stable", visibility:"private", tags:["micro:bit", "BLE", "LEDs", "sensors", "servos", "gamepad", "charts"],
  ...
  { name:"bitmoji-lab", emoji:"🎪", categories:["microbit"], badge:"stable", status:"stable", visibility:"private", tags:["emoji", "micro:bit", "BLE", "LED", "art"],
  ...
  { name:"ble-logger", emoji:"📶", categories:["microbit"], badge:"stable", status:"stable", visibility:"private", tags:["BLE", "micro:bit", "logger", "debug", "tools"],
  ...
  { name:"bonjour", emoji:"📡", categories:["learning"], badge:"new", status:"dev", visibility:"private", tags:["mDNS", "Bonjour", "DNS-SD", "networking", "kids"],
  ...
  { name:"builders-of-light", emoji:"💫", categories:["learning", "arabic", "tools", "classroom", "microbit", "hardware"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "STT", "WLED", "game", "HTML", "LED", "kids"],
  ...
  { name:"circuit-lab", emoji:"🔋", categories:["hardware", "learning"], badge:"dev", status:"beta", visibility:"private", tags:["circuit", "electronics", "simulation", "LED", "resistor"],
  ...
  { name:"classroom", emoji:"🏫", categories:["classroom"], badge:"stable", status:"beta", visibility:"private", tags:["peerjs", "webrtc", "classroom", "video", "room-code"],
  ...
  { name:"claude-toolkit", emoji:"💎", categories:["ai", "tools"], badge:"dev", status:"beta", visibility:"private", tags:["ai", "claude", "anthropic", "prompts", "workflow"],
  ...
  { name:"crypto-academy", emoji:"🪙", categories:["learning"], badge:"stable", status:"beta", visibility:"private", tags:["cryptography", "encryption", "education", "interactive"],
  ...
  { name:"crypto-vault", emoji:"💰", categories:["learning"], badge:"dev", status:"beta", visibility:"private", tags:["cryptography", "encryption", "hashing", "keys", "digital-signatures"],
  ...
  { name:"dhcp-lab", emoji:"🔗", categories:["tools", "hardware"], badge:"new", status:"dev", visibility:"private", tags:["DHCP", "networking", "Python", "dashboard"],
  ...
  { name:"dir-pulse", emoji:"📁", categories:["microbit", "tools", "hardware", "learning"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "game", "HTML"],
  ...
  { name:"emojis", emoji:"😀", categories:["learning"], badge:"new", status:"dev", visibility:"private", tags:["emoji", "visual-coding", "programming", "kids"],
  ...
  { name:"esp32-c3-kids-lab", emoji:"⚡", categories:["hardware", "learning"], badge:"stable", status:"beta", visibility:"private", tags:["ESP32", "C3", "IoT", "sensors", "LED", "WiFi"],
  ...
  { name:"face-quest", emoji:"🕵️", categories:["camera", "ai", "microbit"], badge:"popular", status:"stable", visibility:"private", tags:["camera", "face-detection", "game", "privacy", "local"],
  ...
  { name:"face-tracking", emoji:"👁️", categories:["camera", "microbit"], badge:"stable", status:"stable", visibility:"private", tags:["camera", "face-tracking", "BLE", "events", "kids"],
  ...
  { name:"fihris", emoji:"📂", categories:["tools", "learning", "microbit", "arabic", "hardware"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "camera", "micro:bit", "WLED", "IoT", "linux", "security", "HTML", "robot", "LED", "kids"],
    desc:{ en:"The Workshop-DIY App Catalog", fr:"Fihris — explorez et expérimentez !", ar:"Fihris — استكشف وجرّب!" }},
  { name:"flight-tracker", emoji:"✈️", categories:["learning", "microbit"], badge:"stable", status:"stable", visibility:"private", tags:["flight-tracking", "real-time", "micro:bit", "BLE", "kids"],
  ...
  { name:"flyers", emoji:"📄", categories:["tools"], badge:"stable", status:"stable", visibility:"private", tags:["flyers", "social-media", "marketing", "design"],
  ...
  { name:"git-date-rewrite", emoji:"🕓", categories:["microbit", "tools"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "git", "linux", "security", "LED"],
  ...
  { name:"git-lab", emoji:"🔀", categories:["learning"], badge:"dev", status:"beta", visibility:"private", tags:["git", "version-control", "tutorial", "interactive"],
  ...
  { name:"git-pulse", emoji:"💓", categories:["tools"], badge:"dev", status:"offline", visibility:"private", tags:["GitHub", "repository-manager", "CLI", "developer-tool"],
  ...
  { name:"golden-age", emoji:"🏛️", categories:["learning", "arabic", "classroom"], badge:"stable", status:"stable", visibility:"private", tags:["Islamic-history", "Golden-Age", "interactive", "game", "kids"],
  ...
  { name:"hacktivist-kids", emoji:"🥷", categories:["learning"], badge:"stable", status:"stable", visibility:"private", tags:["cybersecurity", "pranks", "crypto", "hacker-culture", "kids"],
  ...
  { name:"jisr", emoji:"🌉", categories:["arabic", "learning", "hardware"], badge:"new", status:"stable", visibility:"private", tags:["TTS", "WLED", "IoT", "game", "HTML", "LED"],
  ...
  { name:"kalami", emoji:"🗣️", categories:["arabic", "microbit", "ai"], badge:"new", status:"dev", visibility:"private", tags:["BLE", "TTS", "STT", "git", "linux", "HTML", "LED"],
    desc:{ en:"<div align=\"center\">", fr:"Kalami — explorez et expérimentez !", ar:"Kalami — استكشف وجرّب!" }},
  { name:"linkedin", emoji:"💼", categories:["tools"], badge:"stable", status:"stable", visibility:"private", tags:["portfolio", "job-search", "CV", "multilingual"],
  ...
  { name:"linux-kids-lab", emoji:"🐧", categories:["learning"], badge:"stable", status:"beta", visibility:"private", tags:["linux", "terminal", "bash", "commands", "sandbox"],
  ...
  { name:"luminaries-of-islam", emoji:"🌟", categories:["learning", "arabic", "hardware", "microbit", "ai"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "STT", "WLED", "game", "git", "linux", "security", "HTML", "robot", "LED", "kids"],
  ...
  { name:"magic-hands", emoji:"🪄", categories:["camera", "ai"], badge:"popular", status:"stable", visibility:"private", tags:["camera", "hand-tracking", "mediapipe", "effects", "fun"],
  ...
  { name:"makecode-adventures", emoji:"🧱", categories:["microbit", "learning"], badge:"dev", status:"beta", visibility:"private", tags:["makecode", "blocks", "micro:bit", "beginner"],
  ...
  { name:"meridian", emoji:"🧭", categories:["tools", "microbit", "hardware"], badge:"new", status:"dev", visibility:"private", tags:["BLE", "ESP32", "git", "linux", "HTML", "LED"],
  ...
  { name:"morse-code", emoji:"📯", categories:["microbit", "learning", "hardware"], badge:"new", status:"dev", visibility:"private", tags:["morse-code", "BLE", "micro:bit", "audio", "kids"],
  ...
  { name:"mqtt-lab", emoji:"📨", categories:["learning", "hardware"], badge:"new", status:"dev", visibility:"private", tags:["MQTT", "IoT", "pub-sub", "security", "kids"],
  ...
  { name:"ocpp", emoji:"⛽", categories:["tools", "learning"], badge:"new", status:"dev", visibility:"private", tags:["OCPP", "EV-charging", "WebSocket", "Python", "simulation"],
  ...
  { name:"ollama-bot", emoji:"🦙", categories:["ai", "tools"], badge:"new", status:"dev", visibility:"private", tags:["AI", "chatbot", "ollama", "local-LLM", "offline"],
  ...
  { name:"pentest-lab", emoji:"🔐", categories:["learning"], badge:"stable", status:"beta", visibility:"private", tags:["security", "pentest", "hacking", "education", "CTF"],
  ...
  { name:"piper-arabic-tts", emoji:"🎙️", categories:["arabic", "ai"], badge:"stable", status:"beta", visibility:"private", tags:["arabic", "piper", "WASM", "TTS", "neural"],
  ...
  { name:"pixel-gateway", emoji:"🟥", categories:["microbit"], badge:"stable", status:"stable", visibility:"private", tags:["neopixel", "micro:bit", "LED", "emoji"],
  ...
  { name:"posts", emoji:"✍️", categories:["tools"], badge:"stable", status:"stable", visibility:"private", tags:["post-generator", "social-media", "canvas", "PWA"],
  ...
  { name:"production-chain", emoji:"⛓️", categories:["tools", "microbit", "learning"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "git", "linux", "security", "HTML", "LED"],
  ...
  { name:"prompt-hero", emoji:"✨", categories:["ai", "learning"], badge:"dev", status:"beta", visibility:"private", tags:["prompt", "LLM", "ai", "writing", "techniques"],
  ...
  { name:"puppeteer-playground", emoji:"🎭", categories:["tools"], badge:"stable", status:"beta", visibility:"private", tags:["puppeteer", "automation", "scraping", "testing", "headless"],
  ...
  { name:"rocket-shield-vpn", emoji:"🛡️", categories:["tools"], badge:"dev", status:"beta", visibility:"private", tags:["vpn", "network", "security", "privacy"],
  ...
  { name:"rxy", emoji:"🎮", categories:["microbit"], badge:"stable", status:"stable", visibility:"private", tags:["remote", "builder", "micro:bit", "BLE", "no-code"],
  ...
  { name:"sada", emoji:"🌊", categories:["learning", "arabic"], badge:"stable", status:"stable", visibility:"private", tags:["content-archive", "564-files", "multilingual", "educational"],
  ...
  { name:"sanitize-names-toolkit", emoji:"🧹", categories:["tools"], badge:"stable", status:"stable", visibility:"private", tags:["bash", "file-names", "sanitize", "CLI"],
  ...
  { name:"satellites", emoji:"🛰️", categories:["learning", "arabic", "classroom"], badge:"stable", status:"stable", visibility:"private", tags:["satellite-tracking", "astronomy", "Islamic-heritage", "interactive", "kids"],
  ...
  { name:"scapy", emoji:"🕸️", categories:["learning"], badge:"new", status:"dev", visibility:"private", tags:["packets", "networking", "Scapy", "cybersecurity", "kids"],
  ...
  { name:"talking-robot", emoji:"💬", categories:["microbit", "ai"], badge:"stable", status:"stable", visibility:"private", tags:["robot", "speech", "TTS", "STT", "BLE", "emotions"],
  ...
  { name:"teachable-machine", emoji:"🧠", categories:["microbit", "camera", "ai"], badge:"popular", status:"stable", visibility:"private", tags:["ml", "tensorflow", "micro:bit", "BLE", "camera", "gestures"],
  ...
  { name:"termlite", emoji:"⌨️", categories:["tools"], badge:"stable", status:"stable", visibility:"private", tags:["SSH", "SFTP", "VNC", "remote-access", "self-hosted"],
  ...
  { name:"tesbih", emoji:"📿", categories:["arabic"], badge:"new", status:"dev", visibility:"private", tags:["tasbih", "dhikr", "prayer", "counter", "PWA", "Islamic"],
  ...
  { name:"tethkir", emoji:"📔", categories:["arabic", "tools"], badge:"new", status:"dev", visibility:"private", tags:["task-manager", "notes", "encryption", "PWA", "Islamic"],
  ...
  { name:"time-machine", emoji:"🕰️", categories:["learning", "arabic"], badge:"new", status:"dev", visibility:"private", tags:["Islamic-scientists", "history", "game", "interactive", "kids"],
  ...
  { name:"tools", emoji:"🧰", categories:["tools"], badge:"new", status:"stable", visibility:"private", tags:[],
  ...
  { name:"true-crypt", emoji:"🔑", categories:["tools", "microbit"], badge:"new", status:"dev", visibility:"private", tags:["BLE", "git", "security", "crypto", "HTML"],
  ...
  { name:"tty", emoji:"🖥️", categories:["tools", "hardware"], badge:"new", status:"dev", visibility:"private", tags:["serial", "terminal", "bash", "WebSerial", "remote"],
  ...
  { name:"usb-logger", emoji:"🔌", categories:["microbit"], badge:"stable", status:"stable", visibility:"private", tags:["micro:bit", "serial", "USB", "WebSerial", "data"],
  ...
  { name:"warsha", emoji:"🔩", categories:["hardware"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "git", "linux", "HTML"],
    desc:{ en:"بسم الله الرحمن الرحيم", fr:"Warsha — explorez et expérimentez !", ar:"Warsha — استكشف وجرّب!" }},
  { name:"web-kids", emoji:"🕷️", categories:["learning", "microbit", "tools", "arabic", "hardware"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "game", "linux", "HTML", "LED", "kids"],
  ...
  { name:"web-kvm", emoji:"🖱️", categories:["tools", "microbit"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "game", "git", "linux", "security", "crypto", "HTML", "LED"],
  ...
  { name:"wled-kids-lab", emoji:"💡", categories:["hardware", "learning"], badge:"stable", status:"beta", visibility:"private", tags:["WLED", "LED", "ESP32", "neopixel", "colors"],
