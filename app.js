...
const INLINE_APPS = [
  ...
  { name:"amthal", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Amthal — explore and experiment!", fr:"Amthal — explorez et expérimentez !", ar:"Amthal — استكشف وجرّب!" }},
  { name:"apps", emoji:"🛠️", categories:["tools", "camera", "classroom", "arabic", "microbit", "learning"], badge:"new", status:"dev", tags:["BLE","WebRTC","camera","TTS","STT","micro:bit","security","HTML"],
  ...
  { name:"arabic-keyboard", emoji:"🗣️", categories:["arabic"], badge:"new", status:"dev", tags:[],
  ...
  { name:"avahi", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"avahi", fr:"Avahi — explorez et expérimentez !", ar:"Avahi — استكشف وجرّب!" }},
  { name:"bonjour", emoji:"📚", categories:["learning"], badge:"new", status:"dev", tags:["game","security","HTML","LED","kids"],
    desc:{ en:"بِسْمِ ٱللَّٰهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ", fr:"Bonjour — explorez et expérimentez !", ar:"Bonjour — استكشف وجرّب!" }},
  { name:"cowsay", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Cowsay — explore and experiment!", fr:"Cowsay — explorez et expérimentez !", ar:"Cowsay — استكشف وجرّب!" }},
  { name:"dhcp-lab", emoji:"📚", categories:["learning", "tools", "microbit", "hardware"], badge:"new", status:"dev", tags:["BLE","WLED","IoT","git","linux","LED"],
  ...
  { name:"scapy", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Scapy — explore and experiment!", fr:"Scapy — explorez et expérimentez !", ar:"Scapy — استكشف وجرّب!" }},
  { name:"sdr-lab", emoji:"📚", categories:["learning", "microbit", "hardware", "arabic"], badge:"new", status:"dev", tags:["BLE","micro:bit","ESP32","IoT","game","security","HTML","LED"],
    desc:{ en:"> Discover the invisible world of radio waves!", fr:"Sdr Lab — explorez et expérimentez !", ar:"Sdr Lab — استكشف وجرّب!" }},
  { name:"template", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Template — explore and experiment!", fr:"Template — explorez et expérimentez !", ar:"Template — استكشف وجرّب!" }},
  { name:"tesbih", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Tesbih — explore and experiment!", fr:"Tesbih — explorez et expérimentez !", ar:"Tesbih — استكشف وجرّب!" }},
  { name:"tethkir", emoji:"🤖", categories:["microbit", "arabic", "tools"], badge:"new", status:"dev", tags:["BLE","TTS","STT","security","crypto","HTML"],
  ...
  { name:"tshark", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
    desc:{ en:"Tshark — explore and experiment!", fr:"Tshark — explorez et expérimentez !", ar:"Tshark — استكشف وجرّب!" }},
  { name:"tty", emoji:"🤖", categories:["microbit"], badge:"new", status:"dev", tags:["BLE","WebSerial","git","linux","HTML","LED"],
  ...
  { name:"workshop-diy-logos", emoji:"🛠️", categories:["tools"], badge:"new", status:"dev", tags:[],
