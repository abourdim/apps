...
const INLINE_APPS = [
  ...
  { name:"production-chain", emoji:"🏭", categories:["learning"], badge:"stable", status:"beta", tags:["simulation","industry","supply-chain","visual"],
    desc:{ en:"Visualize and simulate an industrial production chain — drag stations, set throughput and watch products flow from raw materials to output.", fr:"Visualisez et simulez une chaîne de production industrielle — placez des stations, réglez le débit et regardez les produits circuler.", ar:"تصوّر ومحاكاة سلسلة إنتاج صناعية — ضع محطات، اضبط الإنتاجية وشاهد المنتجات تتدفق." }},
  ...
  { name:"arabic-speaker", emoji:"🗣️", categories:["arabic"], badge:"stable", status:"beta", tags:["arabic","TTS","STT","web-speech-api"],
    desc:{ en:"Arabic text-to-speech and speech-to-text in the browser using Web Speech API — type or speak, hear or read.", fr:"Synthèse et reconnaissance vocale arabe dans le navigateur via Web Speech API — tapez ou parlez, écoutez ou lisez.", ar:"تحويل النص إلى كلام والكلام إلى نص بالعربية في المتصفح عبر Web Speech API — اكتب أو تحدث، استمع أو اقرأ." }},
  ...
  { name:"amthal", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Amthal — explore and experiment!", fr:"Amthal — explorez et expérimentez !", ar:"Amthal — استكشف وجرّب!" }},
  { name:"apps", emoji:"🛠️", categories:["tools", "camera", "classroom", "arabic", "microbit", "learning"], badge:"new", status:"stable", tags:["BLE","WebRTC","camera","TTS","STT","micro:bit","security","HTML"],
  ...
  { name:"arabic-keyboard", emoji:"🗣️", categories:["arabic"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Arabic Keyboard — explore and experiment!", fr:"Arabic Keyboard — explorez et expérimentez !", ar:"Arabic Keyboard — استكشف وجرّب!" }},
  { name:"avahi", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"avahi", fr:"Avahi — explorez et expérimentez !", ar:"Avahi — استكشف وجرّب!" }},
  { name:"bonjour", emoji:"📚", categories:["learning"], badge:"new", status:"stable", tags:["game","security","HTML","LED","kids"],
    desc:{ en:"بِسْمِ ٱللَّٰهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ", fr:"Bonjour — explorez et expérimentez !", ar:"Bonjour — استكشف وجرّب!" }},
  { name:"cowsay", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Cowsay — explore and experiment!", fr:"Cowsay — explorez et expérimentez !", ar:"Cowsay — استكشف وجرّب!" }},
  { name:"dhcp-lab", emoji:"📚", categories:["learning", "tools", "microbit", "hardware"], badge:"new", status:"stable", tags:["BLE","WLED","IoT","git","linux","LED"],
  ...
  { name:"docker-lab", emoji:"📚", categories:["learning"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Docker Lab — explore and experiment!", fr:"Docker Lab — explorez et expérimentez !", ar:"Docker Lab — استكشف وجرّب!" }},
  { name:"elarabya", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Elarabya — explore and experiment!", fr:"Elarabya — explorez et expérimentez !", ar:"Elarabya — استكشف وجرّب!" }},
  { name:"emojis", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Emojis — explore and experiment!", fr:"Emojis — explorez et expérimentez !", ar:"Emojis — استكشف وجرّب!" }},
  { name:"firebase", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Firebase — explore and experiment!", fr:"Firebase — explorez et expérimentez !", ar:"Firebase — استكشف وجرّب!" }},
  { name:"ierab", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Ierab — explore and experiment!", fr:"Ierab — explorez et expérimentez !", ar:"Ierab — استكشف وجرّب!" }},
  { name:"mdns", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Mdns — explore and experiment!", fr:"Mdns — explorez et expérimentez !", ar:"Mdns — استكشف وجرّب!" }},
  { name:"morse-code", emoji:"🤖", categories:["microbit", "learning", "hardware", "arabic"], badge:"new", status:"stable", tags:["BLE","micro:bit","WLED","IoT","game","linux","security","crypto"],
    desc:{ en:"> بِسْمِ ٱللَّٰهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ", fr:"Morse Code — explorez et expérimentez !", ar:"Morse Code — استكشف وجرّب!" }},
  { name:"mqtt-lab", emoji:"📚", categories:["learning", "hardware", "arabic"], badge:"new", status:"stable", tags:["IoT","game","security","HTML","robot","kids"],
    desc:{ en:"> بِسْمِ ٱللَّٰهِ ٱلرَّحْمَـٰنِ ٱلرَّحِيمِ", fr:"Mqtt Lab — explorez et expérimentez !", ar:"Mqtt Lab — استكشف وجرّب!" }},
  { name:"ngrok", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Ngrok — explore and experiment!", fr:"Ngrok — explorez et expérimentez !", ar:"Ngrok — استكشف وجرّب!" }},
  { name:"nodered-lab", emoji:"📚", categories:["learning"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Nodered Lab — explore and experiment!", fr:"Nodered Lab — explorez et expérimentez !", ar:"Nodered Lab — استكشف وجرّب!" }},
  { name:"ocpp", emoji:"🛠️", categories:["tools", "learning", "microbit"], badge:"new", status:"stable", tags:["BLE","git","HTML"],
  ...
  { name:"ollama-bot", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Ollama Bot — explore and experiment!", fr:"Ollama Bot — explorez et expérimentez !", ar:"Ollama Bot — استكشف وجرّب!" }},
  { name:"openbot", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Openbot — explore and experiment!", fr:"Openbot — explorez et expérimentez !", ar:"Openbot — استكشف وجرّب!" }},
  { name:"ota", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Ota — explore and experiment!", fr:"Ota — explorez et expérimentez !", ar:"Ota — استكشف وجرّب!" }},
  { name:"playwright", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Playwright — explore and experiment!", fr:"Playwright — explorez et expérimentez !", ar:"Playwright — استكشف وجرّب!" }},
  { name:"prompt-example", emoji:"🧠", categories:["ai"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Prompt Example — explore and experiment!", fr:"Prompt Example — explorez et expérimentez !", ar:"Prompt Example — استكشف وجرّب!" }},
  { name:"pyshark", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Pyshark — explore and experiment!", fr:"Pyshark — explorez et expérimentez !", ar:"Pyshark — استكشف وجرّب!" }},
  { name:"python3", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Python3 — explore and experiment!", fr:"Python3 — explorez et expérimentez !", ar:"Python3 — استكشف وجرّب!" }},
  { name:"qrcodes", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Qrcodes — explore and experiment!", fr:"Qrcodes — explorez et expérimentez !", ar:"Qrcodes — استكشف وجرّب!" }},
  { name:"reddis", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Reddis — explore and experiment!", fr:"Reddis — explorez et expérimentez !", ar:"Reddis — استكشف وجرّب!" }},
  { name:"salat-times", emoji:"🤖", categories:["microbit", "arabic", "learning"], badge:"new", status:"stable", tags:["BLE","micro:bit","WLED","git","HTML","makecode","LED","kids"],
  ...
  { name:"scapy", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Scapy — explore and experiment!", fr:"Scapy — explorez et expérimentez !", ar:"Scapy — استكشف وجرّب!" }},
  { name:"sdr-lab", emoji:"📚", categories:["learning", "microbit", "hardware", "arabic"], badge:"new", status:"stable", tags:["BLE","micro:bit","ESP32","IoT","game","security","HTML","LED"],
    desc:{ en:"> Discover the invisible world of radio waves!", fr:"Sdr Lab — explorez et expérimentez !", ar:"Sdr Lab — استكشف وجرّب!" }},
  { name:"template", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Template — explore and experiment!", fr:"Template — explorez et expérimentez !", ar:"Template — استكشف وجرّب!" }},
  { name:"tesbih", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Tesbih — explore and experiment!", fr:"Tesbih — explorez et expérimentez !", ar:"Tesbih — استكشف وجرّب!" }},
  { name:"tethkir", emoji:"🤖", categories:["microbit", "arabic", "tools"], badge:"new", status:"stable", tags:["BLE","TTS","STT","security","crypto","HTML"],
    desc:{ en:"Islamic Task Manager & Secure Notes", fr:"Tethkir — explorez et expérimentez !", ar:"Tethkir — استكشف وجرّب!" }},
  { name:"time-machine", emoji:"📚", categories:["learning", "arabic", "microbit"], badge:"new", status:"dev", tags:["BLE","game","HTML"],
  ...
  { name:"tshark", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Tshark — explore and experiment!", fr:"Tshark — explorez et expérimentez !", ar:"Tshark — استكشف وجرّب!" }},
  { name:"tty", emoji:"🤖", categories:["microbit"], badge:"new", status:"stable", tags:["BLE","WebSerial","git","linux","HTML","LED"],
    desc:{ en:"> Version: see version.py — single source of truth for app name & version.", fr:"Tty — explorez et expérimentez !", ar:"Tty — استكشف وجرّب!" }},
  { name:"workshop-diy-logos", emoji:"🛠️", categories:["tools"], badge:"new", status:"stable", tags:[],
    desc:{ en:"Workshop Diy Logos — explore and experiment!", fr:"Workshop Diy Logos — explorez et expérimentez !", ar:"Workshop Diy Logos — استكشف وجرّب!" }},
];
