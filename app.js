...
const INLINE_APPS = [
  ...
  { name:"AI-hacker-lab", emoji:"🤯", categories:["ai", "learning", "hardware", "tools", "camera"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "tensorflow", "micro:bit", "ESP32", "game", "git", "HTML"],
  ...
  { name:"arabic-tts", emoji:"🔊", categories:["arabic", "ai", "tools"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "game", "git", "linux", "HTML", "LED"],
  ...
  { name:"builders-of-light", emoji:"💫", categories:["learning", "arabic", "classroom"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "STT", "WLED", "game", "HTML", "LED", "kids"],
  ...
  { name:"dir-pulse", emoji:"📁", categories:["tools"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "game", "HTML"],
  ...
  { name:"fihris", emoji:"📂", categories:["tools", "learning", "arabic"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "camera", "micro:bit", "WLED", "IoT", "linux", "security", "HTML", "robot", "LED", "kids"],
  ...
  { name:"git-date-rewrite", emoji:"🕓", categories:["tools"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "git", "linux", "security", "LED"],
  ...
  { name:"luminaries-of-islam", emoji:"🌟", categories:["learning", "arabic", "ai"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "STT", "WLED", "game", "git", "linux", "security", "HTML", "robot", "LED", "kids"],
  ...
  { name:"meridian", emoji:"🧭", categories:["tools", "hardware"], badge:"new", status:"dev", visibility:"private", tags:["BLE", "ESP32", "git", "linux", "HTML", "LED"],
  ...
  { name:"production-chain", emoji:"⛓️", categories:["tools", "learning"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "git", "linux", "security", "HTML", "LED"],
  ...
  { name:"true-crypt", emoji:"🔑", categories:["tools"], badge:"new", status:"dev", visibility:"private", tags:["BLE", "git", "security", "crypto", "HTML"],
  ...
  { name:"web-kids", emoji:"🕷️", categories:["learning", "arabic"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "TTS", "game", "linux", "HTML", "LED", "kids"],
  ...
  { name:"web-kvm", emoji:"🖱️", categories:["tools", "hardware"], badge:"new", status:"stable", visibility:"private", tags:["BLE", "game", "git", "linux", "security", "crypto", "HTML", "LED"],
