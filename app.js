...
const INLINE_APPS = [
  ...
  { name:"bit-playground", emoji:"🧩", categories:["microbit"], badge:"stable", status:"stable", tags:["micro:bit","BLE","LEDs","sensors","servos","gamepad"],
  ...
  { name:"all", emoji:"🏠", categories:["tools"], badge:"hub", status:"stable", tags:["hub","portal","apps","index"],
    desc:{ en:"The Workshop-Diy apps hub — search, filter and launch every mini-app from one place.", fr:"Le hub d'apps Workshop-Diy — cherchez, filtrez et lancez toutes les mini-apps au même endroit.", ar:"مركز تطبيقات Workshop-Diy — ابحث، فلتر وأطلق كل التطبيقات المصغرة من مكان واحد." }},
